...
HA 2021.6 changed the way it displays the more-info, in particular the attributes on the more-info panel. Attributes now under a fold-down, and current custom-ui is not capable of hiding attributes in that fold-down.
